...
<table style="border-spacing:15px;border:0px">
    <tr>
        <td style="border:none">
            <a href="https://open.spotify.com/track/1qG7RYyOShZJ2hn6XNagUa" target="_blank" style="padding:15px;pointer-events:auto">
                <img src="https://i.scdn.co/image/ab67616d0000b2738cb5cb7f800217674a0755ca" alt="Song image" width="100px" height="100px">
            </a>
        </td>
        <td style="border:none">
            <b style="font-size:20px;margin:5px">獨上C樓</b>
            <p style="font-size:18px;margin:5px">YELLOW黃宣, Mavis Fan</p>
        </td>
    </tr>
</table>
