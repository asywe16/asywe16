...
<table style="border-spacing:15px;border:0px">
    <tr>
        <td style="border:none">
            <a href="https://open.spotify.com/track/3353R7ZeupOP7Rp7o94mqa" target="_blank" style="padding:15px;pointer-events:auto">
                <img src="https://i.scdn.co/image/ab67616d0000b273a01fed49fe3a84a9919cef29" alt="Song image" width="100px" height="100px">
            </a>
        </td>
        <td style="border:none">
            <b style="font-size:20px;margin:5px">Lonely (with benny blanco)</b>
            <p style="font-size:18px;margin:5px">Justin Bieber, benny blanco</p>
        </td>
    </tr>
</table>
