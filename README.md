...
<table style="border-spacing:15px;border:0px">
    <tr>
        <td style="border:none">
            <a href="https://open.spotify.com/track/6KRHMYPIWRgFWlXPgqO2Fp" target="_blank" style="padding:15px;pointer-events:auto">
                <img src="https://i.scdn.co/image/ab67616d0000b273d72fb5571087bca0a2fed008" alt="Song image" width="100px" height="100px">
            </a>
        </td>
        <td style="border:none">
            <b style="font-size:20px;margin:5px">Cabinet Battle #2</b>
            <p style="font-size:18px;margin:5px">Christopher Jackson, Daveed Diggs, Lin-Manuel Miranda, Okieriete Onaodowan</p>
        </td>
    </tr>
</table>
