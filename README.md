...
<table style="border-spacing:15px;border:0px">
    <tr>
        <td style="border:none">
            <a href="https://open.spotify.com/track/63oTx2gvxdNv9qGYQCA005" target="_blank" style="padding:15px;pointer-events:auto">
                <img src="https://i.scdn.co/image/ab67616d0000b273b5a4cc430232421ee192dfd1" alt="Song image" width="100px" height="100px">
            </a>
        </td>
        <td style="border:none">
            <b style="font-size:20px;margin:5px">Tiny Little Boy</b>
            <p style="font-size:18px;margin:5px">Rad Museum, DEAN</p>
        </td>
    </tr>
</table>
